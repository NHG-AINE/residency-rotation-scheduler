...
BALANCING_GROUPS = {
  ...
  "Derm (NSC)": ["Derm (NSC)"],
  "ED (TTSH)": ["ED (TTSH)"],
  "Endocrine (KTPH)": ["Endocrine (KTPH)"],
  "Endocrine (TTSH)": ["Endocrine (TTSH)"],
  "Gastro (TTSH)": ["Gastro (TTSH)"],
  "GM (CGH)": ["GM (CGH)"],
  "GM (KTPH)": ["GM (KTPH)"],
  "GM (NUH)": ["GM (NUH)"],
  "GM (SGH)": ["GM (SGH)"],
  ...
  "GM (WH)": ["GM (WH)"],
  "GRM (KTPH)": ["GRM (KTPH)"],
  "Haemato (TTSH)": ["Haemato (TTSH)"],
  "ID (TTSH)": ["ID (TTSH)"],
  "MICU (KTPH)": ["MICU (KTPH)"],
  "MICU (TTSH)": ["MICU (TTSH)"],
  "Med Onco (NCC)": ["Med Onco (NCC)"],
  "Med Onco (TTSH)": ["Med Onco (TTSH)"],
  "NL (NNI)": ["NL (NNI)"],
  "PMD (TTSH)": ["PMD (TTSH)"],
  "RAI (TTSH)": ["RAI (TTSH)"],
  "RCCM (KTPH)": ["RCCM (KTPH)"],
  "RCCM (TTSH)": ["RCCM (TTSH)"],
  "Rehab (TTSH)": ["Rehab (TTSH)"],
  "Renal (KTPH)": ["Renal (KTPH)"],
  "Renal (TTSH)": ["Renal (TTSH)"],
  "GRM (TTSH) and MedComm (TTSH)": ["GRM (TTSH)", "MedComm (TTSH)"],
}
